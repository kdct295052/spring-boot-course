package top.wby.boot.filter_interceptor.controller;

import jakarta.servlet.http.HttpServletRequest;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import top.wby.boot.filter_interceptor.annotation.RequireRole;
import top.wby.boot.filter_interceptor.dto.LoginRequest;
import top.wby.boot.filter_interceptor.dto.LoginResponse;
import top.wby.boot.filter_interceptor.entity.User;
import top.wby.boot.filter_interceptor.result.Result;
import top.wby.boot.filter_interceptor.service.UserService;
import top.wby.boot.filter_interceptor.util.JwtUtil;
